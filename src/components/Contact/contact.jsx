      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 mt-16">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-5 bg-[#FFF8F0] p-6 rounded-2xl">
              <Phone className="text-yellow-600" size={30} />
              <div>
                <h3 className="font-bold text-xl">தொலைபேசி</h3>
            ...
            <div className="flex items-center gap-5 bg-[#FFF8F0] p-6 rounded-2xl">
              ...
              <div>
                <h3 className="font-bold text-xl">மின்னஞ்சல்</h3>
            ...
            <div className="flex items-center gap-5 bg-[#FFF8F0] p-6 rounded-2xl">
              ...
              <div>
                <h3 className="font-bold text-xl">முகவரி</h3>
                <p className="text-gray-600">
          ...
          <form
            ...
            className="bg-[#FFF8F0] p-8 rounded-3xl shadow-lg"
          >
            <input
              type="text"
            ...
            <input
              type="number"
              placeholder="எதிர்பார்க்கப்படும் விருந்தினர்கள் (Guests Count)"
              className="w-full p-4 rounded-xl border mb-4"
            />
